...
create_clock -add -name pll_clk -period 5.00 [get_pins rst_sync_pll_inst/clk_wiz_0_inst/clk_out1];
# create_clock -add -name pll_clk -period 5.00 [get_pins rst_sync_pll_inst/clk_wiz_0_inst/clk_out1];


# set_input_delay -clock pll_clk -max 0.1 [get_ports RX_LINE]
...
set_property -dict { PACKAGE_PIN E5    IOSTANDARD LVCMOS33 } [get_ports { RX_RTS }]; #IO_L5N_T0_AD13N_35 Sch=uart_rts
