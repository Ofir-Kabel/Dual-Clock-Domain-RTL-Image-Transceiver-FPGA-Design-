  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      case (nst)
        ...
        SEND_FRAME: begin
          o_tx_mac_ready <= 1'b0;
          if (i_tx_phy_ready || pst == IDLE) o_tx_phy_str <= 1'b1;
          else o_tx_phy_str <= 1'b0;

          if (i_tx_phy_done && byte_index == 16'd15) begin  //or 17
